...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		needDivider = a.getBoolean(R.styleable.PagerSlidingTabStrip_showDivider, needDivider);
	...
	public void setTabLayoutParams(LinearLayout.LayoutParams lp){
		defaultTabLayoutParams = lp;
	}
