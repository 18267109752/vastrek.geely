...
package com.facebook.rebound.test;
...
/**
 * This Activity presents an ImageView that scales down when pressed and returns
 * to full size when released. This demonstrates a very simple integrates a very
 * Simple integration of a Rebound Spring model to drive a bouncy animation as
 * the photo scales up and down. You can control the Spring configuration by
 * tapping on the blue nub at the bottom of the screen to reveal the
 * SpringConfiguratorView. From this view you can adjust the tension and
 * friction of the animation spring and observe the effect these values have on
 * the animation.
 */
