...
public class SpringConfiguratorView extends FrameLayout {
	...
	private View generateHierarchy(Context context) {
		...
		params = createLayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
				dpToPx(300, resources));
		...
		params = createLayoutParams(dpToPx(50, resources),
		...
		params = createLayoutParams(dpToPx(60, resources),
				dpToPx(40, resources));
